<template>
  <q-layout view="lHh Lpr lFf">
    <!-- Sidebar / Drawer -->
    <q-drawer :model-value="true" :width="280" :breakpoint="700" show-if-above no-swipe-close>
          ...
          <div>
            ...
            <transition name="submenu">
              <div v-if="reservacionesOpen" class="sidebar__submenu">
                ...
                >
                  <span class="sidebar__res-dot" :class="`sidebar__res-dot--${res.status}`"></span>
...
const recentReservaciones = computed(() =>
  resStore.reservaciones
    ...
    .map((r) => ({
      ...
      fecha: new Date(r.fecha_evento + 'T00:00:00').toLocaleDateString('es-MX', {
        day: '2-digit',
        month: 'short',
      }),
