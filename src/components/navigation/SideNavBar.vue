  ...
  <aside :class="sidebarClass">
    <div class="sidebar-brand-section">
      <div class="brand-row">
        ...
        <button class="btn-toggle" aria-label="Toggle sidebar" @click="toggle">
          <q-icon name="chevron_left" />
        </button>
      </div>

      <div v-if="!internalCollapsed" class="profile-box">
    ...
    <nav class="sidebar-nav">
      ...
      >
        ...
        <span v-if="!internalCollapsed" class="nav-text">{{ item.label }}</span>
      </button>
    </nav>

    <div v-if="!internalCollapsed" class="sidebar-footer">
...
.collapsed-sidebar .brand-logo {
  font-size: 16px !important;
}
.collapsed-sidebar .profile-box {
  display: none;
}
