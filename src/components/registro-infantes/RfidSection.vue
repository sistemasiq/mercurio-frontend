...
<template>
  <q-card flat bordered class="rfid-card q-mb-md">
    <q-card-section>
      ...
      <!-- Loading pulseras -->
      <div v-if="store.isLoadingPulseras" class="text-center q-py-md">
        <q-spinner color="primary" size="28px" />
        <div class="text-caption text-grey-6 q-mt-sm">Cargando pulseras disponibles...</div>
      </div>
