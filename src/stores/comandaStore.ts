...
export const useComandasStore = defineStore('comandas', () => {
      ...
      items: [
        {
          ...
          cantidad: 2,
          precioUnitario: 85,
          observaciones: 'Sin cebolla, extra pepinillos',
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          cantidad: 1,
          precioUnitario: 90,
          observaciones: 'Alergia: Sin crutones',
        },
      ],
    },
    {
  ...
  const comandasEnCocina = computed(() =>
    _comandas.value.filter(
      (c) => c.estado === 'pendiente' || c.estado === 'en_proceso' || c.estado === 'listo',
    ),
  )
